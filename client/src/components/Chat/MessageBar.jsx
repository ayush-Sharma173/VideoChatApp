...
export default function MessageBar() {
  ...
  return (
    <div className="bg-panel-header-background2  h-20 px-4 flex items-center gap-6  relative">
      {!showAudioRecorder && (
        <>
          <div className="flex gap-6">
            <BsEmojiSmile
              className="text-panel-header-icon cursor-pointer text-xl"
              style = {{backgroundColor: "black",backgroundSize : "auto"}}
              title="Emoji"
          ...
          <div className=" w-10 flex items-center justify-center" style = {{backgroundColor: "black",backgroundSize : "auto"}}>
            {message.length ? (
